...
export const Header = () => {
  ...
  return (
    <div className='w-full h-20 bg-amazon_blue text-lightText sticky top-0 z-50'>
        ...
        <Image className='w-28 object-cover mt-1' src={logo} alt='headerlogo'/>
        </Link>
    ...
    <div className="text-xs text-gray-100 flex flex-col justify-center px-2 border border-transparent hover:border-white cursor-pointer duration-300 h-[70%] relative">
        <p>Marked</p>
          ...
          {favoriteData.length>0 && <span  className="absolute right-2 top-2 w-4 h-4 border-[1px] border-gray-400 flex items-center justify-center text-xs text-amazon_yellow">
    ...
    <Link href={"/cart"} className="flex items-center px-2 border border-transparent hover:border-white cursor-pointer duration-300 h-[70%] relative">
        <Image className="w-auto object-cover h-8" src={cartIcon} alt='cart'/>
